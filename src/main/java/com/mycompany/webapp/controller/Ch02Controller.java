...
public class Ch02Controller {
	...
	//요청했을 때 아래 코드 처리해서 데이터를 준다
	//@RequestMapping("/request1") //GET,POST 둘 다 지원
	...
	public String joinForm() {
		logger.info("회원가입 양식 보냄"); //로그
		return "ch02/joinForm"; //회원가입 폼 달라
	}
	...
	public String joinFormAsync() {
		logger.info("회원가입 양식 보냄"); //로그
		return "ch02/joinFormAsync"; //회원가입 폼 달라
	}
}
